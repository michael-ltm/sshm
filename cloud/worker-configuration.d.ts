/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab234565ef3c228475356691a3033e58)
// Runtime types generated with workerd@1.20260903.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	REGISTRATION: "open";
	ACCOUNTS: DurableObjectNamespace<import("./src/index").Account>;
	LIMITER: DurableObjectNamespace<import("./src/index").Limiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Account" | "Limiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGISTRATION">> {}
}
