...
ai-patterns) + /server command + .mcp.json which auto-registers
`sshm mcp`. Install: claude plugins marketplace add michael-ltm/sshm
then claude plugins install sshm-skill@sshm."
```
